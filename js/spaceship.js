...
export class Spaceship extends BaseSpaceship {
    ...
    makeEnemy() {
        ...
        if (!this.gameOver) {
            ...
            if ((enemy.lastYPosition == null ? enemy.initialYPosition : enemy.lastYPosition) + enemy.marginY < canvas.height - enemy.colisionY * 2.5) {
    ...
    drawEnemies() {
        ...
        this.enemies.forEach((enemy) => {
            ...
            if (enemy.lastYPosition >= canvas.height - this.colisionY) {
                ...
                this.clearCanvas();
                this.gameOver = true;
                context.drawImage(gameOver, (canvas.width / 2) - 200, (canvas.height / 2) - 200);
